  ...
  <div class="bg-white p-10 md:w-3/4 lg:w-1/2 mx-auto">
    ...
    <form @submit.prevent="addNewStatus">
      ...
      <div class="flex items-center mb-5">
        ...
        <input type="text" required id="name" v-model="statusnew.title" placeholder="title"
      ...
      <div class="flex items-center mb-10">
        <label for="twitter" class="inline-block w-20 mr-6 text-right
                                    font-bold text-gray-600">Order</label>
        <input type="number"  min="0" max="10" id="twitter" v-model="statusnew.order"
      ...
      <div class="text-right">
        <button class="py-3 px-8 bg-green-400 text-white font-bold">Add New </button>
      </div>
