...
export default {
  ...
  mounted() {
    ...
    this.newTask.title = this.taskupdate.title
    this.newTask.id = this.taskupdate.id;
    this.newTask.description = this.taskupdate.description;
  },
  methods: {
    handleupdateTask() {
      ...
      if (!this.newTask.title) {
       ...
       // console.log(`/tasks/${this.newTask.id}`, { title:this.newTask.title,description:this.newTask.description} );
      // Send updated task to server
      axios
        .put(`/tasks/${this.newTask.id}`, { title:this.newTask.title,description:this.newTask.description})
        .then(res => {
            console.log(res);
